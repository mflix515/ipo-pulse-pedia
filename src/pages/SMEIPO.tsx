      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="hidden lg:block lg:col-span-2">
            <AdPlacement size="sidebar" position="sme-left-sidebar" />
          </div>
          ...
          <div className="lg:col-span-8">
            <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
              ...
              <p className="text-gray-600 mb-6">
                Explore Small and Medium Enterprise IPO opportunities with detailed analysis and insights.
                Track emerging companies and their growth potential in the SME segment.
              </p>

              {/* Banner Ad */}
              <AdPlacement size="banner" position="sme-hero-banner" className="mb-6" />
                  ...
                  <TabsContent key={status} value={status} className="mt-6">
                    ...
                    {filteredIPOs.length === 0 ? (
                      <div className="text-center py-12">
                        <p className="text-gray-500">No {status} SME IPOs found.</p>
                      </div>
                    ) : (
                    ...
                    {filteredIPOs.length > 6 && (
                      <div className="mt-8">
                        <AdPlacement size="banner" position={`sme-${status}-content`} />
                      </div>
                    )}
                  </TabsContent>
                ))}
            ...
            <div className="lg:hidden mb-6">
              <AdPlacement size="mobile" position="sme-mobile-banner" />
            </div>
          </div>
          ...
          <div className="hidden lg:block lg:col-span-2">
            <div className="space-y-6">
              <AdPlacement size="sidebar" position="sme-right-sidebar-1" />
              <AdPlacement size="square" position="sme-right-sidebar-2" />
            </div>
          </div>
        </div>
      </div>
